...
* **AI Engine:** Llama 3 (Exam generation & pedagogical insights).
...
4.  **Scope Limitation:** The grading system strictly uses Optical Mark Recognition (OMR) for standardized multiple-choice bubble sheets. No handwritten text recognition (OCR).