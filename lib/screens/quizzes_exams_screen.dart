  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          _buildExamTile(
              'Midterm Exam', 'June 15, 2026', 'Completed', Colors.green),
          _buildExamTile(
              'Quiz 3: Convolution', 'June 22, 2026', 'Upcoming', Colors.blue),
          _buildExamTile(
              'Final Examination', 'July 15, 2026', 'Scheduled', Colors.red),
        ],
      ),
          ...
          ? FloatingActionButton(
              onPressed: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        const AIQuestionnaireScreen(type: 'Quiz/Exam'),
                  ),
                );
              },
